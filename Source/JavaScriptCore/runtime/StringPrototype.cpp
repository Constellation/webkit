...
void StringPrototype::finishCreation(VM& vm, JSGlobalObject* globalObject)
{
    ...
    putDirectWithoutTransition(vm, vm.propertyNames->iteratorSymbol, globalObject->stringProtoSymbolIteratorFunction(), static_cast<unsigned>(PropertyAttribute::DontEnum));
