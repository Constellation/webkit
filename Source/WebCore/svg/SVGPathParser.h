...
class SVGPathParser {
public:
    static constexpr float gOneOverThree = 1 / 3.f;

    static bool parse(Source&, Consumer&, PathParsingMode = NormalizedParsing, bool checkForInitialMoveTo = true);

    static bool parseToByteStream(Source&, SVGPathByteStream&, PathParsingMode = NormalizedParsing, bool checkForInitialMoveTo = true);
    static bool parseToString(Source&, String& result, PathParsingMode = NormalizedParsing, bool checkForInitialMoveTo = true);

private:
    SVGPathParser(Consumer&, Source&, PathParsingMode);
...
template<typename Source, typename Consumer>
bool SVGPathParser<Source, Consumer>::parse(Source& source, Consumer& consumer, PathParsingMode mode, bool checkForInitialMoveTo)
{
    SVGPathParser<Source, Consumer> parser(consumer, source, mode);
    return parser.parsePathData(checkForInitialMoveTo);
}

template<typename Source, typename Consumer>
bool SVGPathParser<Source, Consumer>::parseToByteStream(Source& source, SVGPathByteStream& byteStream, PathParsingMode mode, bool checkForInitialMoveTo)
{
...
template<typename Source, typename Consumer>
bool SVGPathParser<Source, Consumer>::parseToString(Source& source, String& result, PathParsingMode mode, bool checkForInitialMoveTo)
{
    SVGPathStringBuilder builder;
    SVGPathParser<Source, Consumer> parser(builder, source, mode);
...
template<typename Source, typename Consumer>
void SVGPathParser<Source, Consumer>::parseClosePathSegment()
{
...
template<typename Source, typename Consumer>
bool SVGPathParser<Source, Consumer>::parseMoveToSegment()
{
...
template<typename Source, typename Consumer>
bool SVGPathParser<Source, Consumer>::parseLineToSegment()
{
...
template<typename Source, typename Consumer>
bool SVGPathParser<Source, Consumer>::parseLineToHorizontalSegment()
{
...
template<typename Source, typename Consumer>
bool SVGPathParser<Source, Consumer>::parseLineToVerticalSegment()
{
...
template<typename Source, typename Consumer>
bool SVGPathParser<Source, Consumer>::parseCurveToCubicSegment()
{
...
template<typename Source, typename Consumer>
bool SVGPathParser<Source, Consumer>::parseCurveToCubicSmoothSegment()
{
...
template<typename Source, typename Consumer>
bool SVGPathParser<Source, Consumer>::parseCurveToQuadraticSegment()
{
...
template<typename Source, typename Consumer>
bool SVGPathParser<Source, Consumer>::parseCurveToQuadraticSmoothSegment()
{
...
template<typename Source, typename Consumer>
bool SVGPathParser<Source, Consumer>::parseArcToSegment()
{
...
template<typename Source, typename Consumer>
bool SVGPathParser<Source, Consumer>::parsePathData(bool checkForInitialMoveTo)
{
...
template<typename Source, typename Consumer>
bool SVGPathParser<Source, Consumer>::decomposeArcToCubic(float angle, float rx, float ry, FloatPoint& point1, FloatPoint& point2, bool largeArcFlag, bool sweepFlag)
{
